...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="add-ecategory.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
...
<div class="row">
  ...
  <tbody>
    ...
    $category = "SELECT * FROM ecategory";
    ...
    <tr>
      ...
      <td><a href="edit-ecategory.php?cat_id=<?php echo $row['id']; ?>" class="btn btn-warning ">Edit</a> | <a href="delete-ecategory.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
